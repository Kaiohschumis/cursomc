...
import com.kaio.cursomc.repositories.*;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat5 = new Categoria(null, "Stone Age");
		Categoria cat6 = new Categoria(null, "XTT");
		Categoria cat7 = new Categoria(null, "Padoguinho");
